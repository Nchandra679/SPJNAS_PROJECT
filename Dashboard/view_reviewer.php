        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-user fa-fw"></i> Reviewer<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
            ...
            <div id="page-inner">
				...
				<?php
					...
					if(isset($_SESSION['IDs']))
					{
						...
						$get_manuscript = new Reviewer();
						
						$result = $get_manuscript->get_ReviewManuscripts($u_id);
						...
						$report .=  "<th style=\"color:#ff9900; text-align: center;\">View Manuscript</th>";
						$report .= "</thead>";											
						...
						if($result)
						{
							foreach($result as $key) 
							{
								...
								$report .= "<a href=\"view_details_reviewers.php?id=" . urlencode($key["ID"]) . "\">View Details</a>";
								$report .= "</td>";
						...
						{
							$report .= "<tr style=\"background-color:white;\">". htmlentities("No Manuscript To Review");							
							$report .= "</tr>";
						}
