            ...
            <div id="page-inner">
				...
				<?php
					...
					if(isset($_SESSION['IDs']))
					{
						...
						$result = $get_manuscript->get_manuscripts_editor();
						...
						if($result)
						{
							foreach($result as $key) 
							{
								...
								$report .= "<a href=\"view_details_editor.php?id=" . urlencode($key["ID"]) . "\">View Details</a>";
								$report .= "</td>";
						...
						{
							$report .= "<tr style=\"background-color:white;\">". htmlentities("No Manuscript Submitted");							
							$report .= "</tr>";
						}
