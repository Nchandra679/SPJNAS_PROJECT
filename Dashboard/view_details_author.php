		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            View Manuscript Details <small>Welcome</small>
                        </h1>
						<ol class="breadcrumb">
            ...
            <div class="jumbotron">
              ...
              <div class="form-row">
              <label class="control-label">Authors: </label><p></p>
			  	<?php	
              ...
              <div class="form-row">
              <label class="control-label">Review process: </label>
			  </div>
				<?php
					if($result["Submit"])
					{
						echo $result["Review_Process"];
				?>
				
				<div class="form-row">
				<label class="control-label">Comments: </label>
				<?php
						if($result["Review_Process"] != "Under Review")
						{
							$data = new Reviewer();
							$val = $data->get_reviewer_comments($id);
							echo $val["Comments"];
						}
					...
					{
						echo "Submit to Start Review Process";
					}
				?>
			  <p></p>
              </div>
              ...
              <div class="class="form-row"">
				...
				?>
				  ...
				  <p></p>
             <div class="class="form-row"">
				<label class="control-label">Cover letter: </label></div>
				<?php  
				...
				?>
				<p></p>
              <div class="class="form-row""><label class="control-label">Highlights: </label> </div>
				<?php  
              ...
              <div class="form-row">
				...
				<div class="col-sm-6">
				<?php if(!$result["Submit"])
					{
						echo "<a href=\"submit.php?id=".urlencode($id). "\"> Submit </a>"; 
				?>
<!--				
				<div class="col-sm-6">
				<?php
					//echo "<a href=\"submit.php?id=".urlencode($id). "\"> Delete </a>"; 
				}
				?>
			-->	</div>
				</div>
