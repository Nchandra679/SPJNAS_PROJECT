            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
						...
						?>
                        <li>
                        <a class="active-menu" href="#"><i class="fa fa-user fa-fw"></i> Forms<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
...
<div class="jambotron">
<p>CSIRO licence to publish form is attached. Click the download button to download it.</p>
<a href="forms/CSIRO.pdf"><button type="button"  class="btn btn-primary"> Download</button></a></div>
