...
<head>
    ...
    <title>Reviewer Referee's form</title>
    <!-- Bootstrap Styles-->
		...
		<div id="page-wrapper">
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
                <div class="jumbotron">
		         <form name ="Reviewer_Form" role="form" action="reviewer_feedback.php" enctype="multipart/form-data" method="post">
                        <div class="form-group">

						<label class="form-check-label">Manuscript ID</label>
						<?php
							$id = $_GET["id"];
						?>
                        ...
                        <small class="form-text text-muted"> *Please give appropriate comments to indicate if the revised manuscript should be sent to you for a second review?</small>
                        <br/><p></p>
						</div>
						<label>Select Decision</label>
						<select required="required" name = "decision">
                        ...
                        <div class="form-check">
                            ...
                            <textarea class="form-control" name="Comments" row="3"></textarea><p></p><p></p>
                        </div>						
                        <div class="form-check">
                                <h3>ASSESMENT: Please specify in YES / NO </h3><br/>
                         ...
                         <h3>Content</h3><p></p>
                                ...
                                <input type="checkbox" name="original" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="original" value="No" class="form-check-input"> No</input><p></p> 
                                ...
                                <input type="checkbox" name="Justify" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Justify" value="No" class="form-check-input"> No</input><p></p>

                                <label class="form-check-label">3.  Does/Do the author/authors give due credit to previous work?  </label><br/>
                                <input type="checkbox" name="Credit" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Credit" value="No" class="form-check-input"> No</input><p></p>
                        </div>

                        <div class="form-check">
                         <h3>Presentation</h3><p></p>
                                <label class="form-check-label">1.  Are the title and summary informative and relevant? </label><br/>
                                <input type="checkbox" name="STitle" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="STitle" value="No" class="form-check-input"> No</input><p></p> 

                                <label class="form-check-label">2.  Is the text clear and well-written? </label><br/>
                                <input type="checkbox" name="Clear" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Clear" value="No" class="form-check-input"> No</input><p></p>

                                <label class="form-check-label">3.  Could the text be shortened with advantage?</label><br/>
                                <input type="checkbox" name="Shorten" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Shorten" value="No" class="form-check-input"> No</input><p></p>

                                <label class="form-check-label">4.  Are all the references adequate and satisfactorily cited? </label><br/>
                                <input type="checkbox" name="References" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="References" value="No" class="form-check-input"> No</input><p></p>
                        </div>  

                        <div class="form-check">
                         <h3>Figures and tables</h3><p></p>
                                <label class="form-check-label">1.  Are the illustrations clear and well presented? </label><br/>
                                <input type="checkbox" class=""name="Illustrations" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Illustrations" value="No" class="form-check-input"> No</input><p></p> 

                                <label class="form-check-label">2.  Are all the figures relevant and essential? </label><br/>
                                <input type="checkbox" name="Figures" value="Yes" class="form-check-input"> Yes</input><br/>
                                <input type="checkbox" name="Figures" value="No" class="form-check-input"> No</input><p></p>
